...
public class InfiniteBlockItem extends Item implements PolymerItem {
    ...
    public ItemStack getPolymerItemStack(ItemStack stack, TooltipContext context, @Nullable ServerPlayerEntity player) {
        ...
        lore.add(NbtString.of(Text.Serializer.toJson(Text.translatable("tooltip.boundless_blocks.infinite_item.line1"))));
        lore.add(NbtString.of(Text.Serializer.toJson(Text.literal("§7" + Registries.BLOCK.getId(block)))));
    ...
    public net.minecraft.util.TypedActionResult<ItemStack> use(World world, PlayerEntity player, net.minecraft.util.Hand hand) {
        ...
        Block block = getBlock(stack);
        if (block == null) return net.minecraft.util.TypedActionResult.fail(stack);
        ...
        return remaining < 9 ? net.minecraft.util.TypedActionResult.success(stack) : net.minecraft.util.TypedActionResult.pass(stack);
    }
    ...
    public static Block getBlock(ItemStack stack) {
        ...
        if (nbt.contains(BLOCK_KEY)) {
            ...
            nbt.putString(BLOCK_KEY, blockId);
